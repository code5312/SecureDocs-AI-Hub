...
class ErrorCode:
    ...
    DOCUMENT_ACL_NOT_FOUND = "DOCUMENT_ACL_NOT_FOUND"
    DOCUMENT_ACL_INVALID_PRINCIPAL = "DOCUMENT_ACL_INVALID_PRINCIPAL"
    DOCUMENT_ACL_DUPLICATED = "DOCUMENT_ACL_DUPLICATED"
    DOCUMENT_ACL_QUERY_TOO_SHORT = "DOCUMENT_ACL_QUERY_TOO_SHORT"
